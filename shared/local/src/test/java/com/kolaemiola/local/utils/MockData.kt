package com.kolaemiola.local.utils
...
object MockData {
  val mockArticleEntity0 = ArticleEntity(
  ...
  val mockArticleEntity1 = ArticleEntity(
  ...
  val mockArticleEntity2 = ArticleEntity(
    author = "Mike Wehner",
  ...
  val mockArticleEntity3 = ArticleEntity(
    author = "Jordan Novet",
  ...
  val mockArticlesEntity = listOf(mockArticleEntity0, mockArticleEntity1, mockArticleEntity2, mockArticleEntity3)
