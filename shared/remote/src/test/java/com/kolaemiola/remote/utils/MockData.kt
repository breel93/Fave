...
import com.kolaemiola.remote.model.*
import java.text.ParseException
import java.text.SimpleDateFormat
import java.util.*

object MockData {
  val mockArticle0 = ArticleRemoteModel(
    author = null, title = "PlayStation Plus Free Games for July 2020 - IGN Daily Fix - IGN",
    ...
    publishedAt = date("2020-06-29T22:31:54Z"), content = null,
    source = ArticleSourceRemoteModel(
      name = "YouTube"
    )
  )
  val mockArticle1 = ArticleRemoteModel(
  ...
  val mockArticle2 = ArticleRemoteModel(
    author = "Mike Wehner",
  ...
  val mockArticle3 = ArticleRemoteModel(
    author = "Jordan Novet",
  ...
  val mockArticleResponse = ArticleResponse(
    status = "ok", totalResults = 4, articles = mockArticles
  )

  val mockSource0 = SourceRemoteModel(
    id = "abc-news",
    name = "ABC News",
  ...
  val mockSource1 = SourceRemoteModel(
    id = "abc-news-au",
    name = "ABC News (AU)",
  ...
  val mockSource2 = SourceRemoteModel(
    id = "aftenposten",
    name = "Aftenposten",
  ...
  val mockSource3 = SourceRemoteModel(
  ...
  val mockSourceResponse = SourceResponse(status = "ok", sources = mockSources)
